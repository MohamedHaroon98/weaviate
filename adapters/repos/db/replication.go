...
func (i *Index) writableShard(name string) (ShardLike, func(), *replica.SimpleResponse) {
	localShard, release, err := i.getInitializedLocalShard(context.Background(), name)
	if err != nil {
...
func (i *Index) CommitReplication(shard, requestID string) interface{} {
	localShard, release, err := i.getInitializedLocalShard(context.Background(), shard)
	if err != nil {
...
func (i *Index) IncomingFilePutter(ctx context.Context, shardName,
	...
	localShard, release, err := i.getInitializedLocalShard(context.Background(), shardName)
	if err != nil {
...
func (i *Index) OverwriteObjects(ctx context.Context,
	...
	s, release, err := i.getInitializedLocalShard(ctx, shard)
	if err != nil {
...
func (i *Index) DigestObjects(ctx context.Context,
	...
	s, release, err := i.getInitializedLocalShard(ctx, shardName)
	if err != nil {
...
func (i *Index) FetchObject(ctx context.Context,
	...
	shard, release, err := i.getInitializedLocalShard(ctx, shardName)
	if err != nil {
